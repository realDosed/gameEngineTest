...
public class OBJLoader {
    ...
    public static RawModel loadObjModel(String fileName, Loader loader) {
        ...
        try {
            while (true) {
                ...
                if (line.startsWith("v ")) {
                    ...
                    testuresArray = new float[vertices.size() * 2];
            ...
            while (line != null) {
                ...
                processVertex(vertex1, indices, textures, normals, testuresArray, normalsArray);
                processVertex(vertex2, indices, textures, normals, testuresArray, normalsArray);
                processVertex(vertex3, indices, textures, normals, testuresArray, normalsArray);
        ...
        return loader.loadToVAO(verticesArray, testuresArray, normalsArray, indicesArray);
    }
