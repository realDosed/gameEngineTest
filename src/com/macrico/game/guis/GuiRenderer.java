...
public class GuiRenderer {
    ...
    public void renderWater(GuiTexture waterTexture) {
        shader.start();
        GL30.glBindVertexArray(quad.getVaoID());
        GL20.glEnableVertexAttribArray(0);
        GL11.glEnable(GL11.GL_BLEND);
        ...
        GL13.glActiveTexture(GL13.GL_TEXTURE0);
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, waterTexture.getTexture());
        Matrix4f matrix = Maths.createTransformationMatrix(waterTexture.getPosition(), waterTexture.getScale());
        shader.loadTransformation(matrix);
        GL11.glDrawArrays(GL11.GL_TRIANGLE_STRIP, 0, quad.getVertexCount());
